...
import 'package:flutter_firebase_login/makearoom2/bloc/makearoom_bloc.dart';
import 'package:flutter_firebase_login/makearoom2/bloc/makearoom_state.dart';
import 'package:flutter_firebase_login/user_repository.dart';
import 'package:shared_preferences/shared_preferences.dart';

import 'bloc/bloc.dart';

class MakeARoom2 extends StatefulWidget {
  ...
  MakeARoom2(
      ...
      : assert(userRepository != null),
        ...
        super(key: key);
  @override
  _MakeARoomState2 createState() => _MakeARoomState2();
}

class _MakeARoomState2 extends State<MakeARoom2> {
  MakeARoomBloc2 _makeARoomBloc2;
  ...
  void initState() {
    super.initState();
    _makeARoomBloc2 = BlocProvider.of<MakeARoomBloc2>(context);
  ...
  Widget build(BuildContext context) {
    return BlocListener<MakeARoomBloc2, MakeARoomState2>(listener:
        (context, state) {
      ...
      if (state.isGo) {
        ...
        BlocBuilder<MakeARoomBloc2, MakeARoomState2>(builder: (context, state) {
      return ListView(
        children: <Widget>[
          Container(
                ...
                child: Padding(
                  ...
                  child: DropdownButton(
                      ...
                      onChanged: (String newValue) {
                        _makeARoomBloc2.dispatch(MatpelChanged(
                            matpel: newValue,
              ...
              Card(
                child: Padding(
                  ...
                  child: DropdownButton(
                      ...
                      value: state.bab,
                      onChanged: (String newValue) {
                        _makeARoomBloc2.dispatch(BabChanged(bab: newValue));
                      },
            ...
            child: RaisedButton(
              ...
              onPressed: () {
                if (myController.text.length > 0) {
                  _makeARoomBloc2.dispatch(BuatRoomPressed(
                    namaRoom: myController.text,
                    bab: state.bab,
                    tipe: _tipe,
                    mapel: state.matpel,
