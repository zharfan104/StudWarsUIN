...
import 'package:flutter_firebase_login/chat_room2/bloc/chatroom_bloc.dart';
import 'package:flutter_firebase_login/chat_room/chat.dart';
import 'package:flutter_firebase_login/main.dart';
import 'package:flutter_firebase_login/user_repository.dart';

class ChatroomScreen2 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: BlocProvider<ChatroomBloc2>(
        builder: (context) => ChatroomBloc2(
            // userRepository: _userRepository,
            // namaRoom: _namaRoom,
            // roomEmail: _roomEmail,
            ),
