...
import 'package:flutter_firebase_login/chat_room2/bloc/bloc.dart';
...
class Chat2 extends StatefulWidget {
  ...
  @override
  State createState() => new ChatState2(
      roomEmail: roomEmail,
      user: user,
      peerId: peerId,
...
class ChatState2 extends State<Chat2> {
  ChatState2(
      {@required this.email,
      @required this.bab,
  ...
  ChatroomBloc2 _chatroomBloc;
  @override
  void initState() {
    groupChatId = '';
    _chatroomBloc = BlocProvider.of<ChatroomBloc2>(context);
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<ChatroomBloc2, ChatroomState2>(
        bloc: _chatroomBloc,
  ...
  AppBar buildAppBar(ChatroomState2 state, Future<bool> _onWillPop()) {
    return AppBar(
      actions: <Widget>[
        Padding(
