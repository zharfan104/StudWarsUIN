...
abstract class BattleState extends Equatable {
  ...
  BattleState(this.duration, this.isDone, this.idxsoal, this.lokal,
      [List props = const []])
...
class Paused extends BattleState {
...
class Running extends BattleState {
...
class Finished extends BattleState {
