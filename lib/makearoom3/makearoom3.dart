...
import 'package:flutter_firebase_login/makearoom3/bloc/makearoom_bloc.dart';
import 'package:flutter_firebase_login/makearoom3/bloc/makearoom_state.dart';
import 'package:flutter_firebase_login/user_repository.dart';
import 'package:shared_preferences/shared_preferences.dart';

import 'bloc/bloc.dart';

class MakeARoom3 extends StatefulWidget {
  ...
  MakeARoom3(
      ...
      : assert(userRepository != null),
        ...
        super(key: key);
  @override
  _MakeARoomState33 createState() => _MakeARoomState33();
}

class _MakeARoomState33 extends State<MakeARoom3> {
  MakeARoomBloc3 _MakeARoomBloc3;
  ...
  void initState() {
    super.initState();
    _MakeARoomBloc3 = BlocProvider.of<MakeARoomBloc3>(context);
  ...
  Widget build(BuildContext context) {
    return BlocListener<MakeARoomBloc3, MakeARoomState3>(listener:
        (context, state) {
      ...
      if (state.isGo) {
        ...
        BlocBuilder<MakeARoomBloc3, MakeARoomState3>(builder: (context, state) {
      return ListView(
        children: <Widget>[
          Container(
                ...
                child: Padding(
                  ...
                  child: DropdownButton(
                      ...
                      onChanged: (String newValue) {
                        _MakeARoomBloc3.dispatch(MatpelChanged(
                            matpel: newValue,
              ...
              Card(
                child: Padding(
                  ...
                  child: DropdownButton(
                      ...
                      value: state.bab,
                      onChanged: (String newValue) {
                        _MakeARoomBloc3.dispatch(BabChanged(bab: newValue));
                      },
            ...
            child: RaisedButton(
              ...
              onPressed: () {
                if (myController.text.length > 0) {
                  _MakeARoomBloc3.dispatch(BuatRoomPressed(
                    namaRoom: myController.text,
                    bab: state.bab,
                    tipe: _tipe,
                    mapel: state.matpel,
